...
This vector sets the top $z$-coordinate of each layer, going from the surface towards the middle, separated by spaces. The first entry is the slab surface and therefore fixes {\tt photo\_slab\_max}; the remaining entries are the boundaries between the boxes, and {\tt photo\_slab\_middle} closes the last one.
